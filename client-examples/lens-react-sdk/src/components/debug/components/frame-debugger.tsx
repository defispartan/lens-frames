    ...
    <div className="flex flex-row items-start p-4 gap-4 bg-slate-50 max-w-full w-full h-full">
      <div className="flex flex-col gap-4 w-[300px] min-w-[300px]">
        ...
        <div className="border rounded-lg shadow-sm bg-white">
          ...
          >
            <span className="text-black px-2 w-9 relative text-center inline-block">
              <svg
          ...
          >
            <span className="text-black px-2 w-9 relative text-center inline-block bottom-[1px]">
              ⬗
            </span>
                  ...
                  <Table>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell className="text-slate-500">
                          {frameState.framesStack[0]!.speed > 5
                            ? `Request took more than 5s (${
                                frameState.framesStack[0]!.speed
                              } seconds). This may be normal: first request will take longer in development (as next.js builds), but in production, clients will timeout requests after 5s`
                            : frameState.framesStack[0]!.speed > 4
                            ? `Warning: Request took more than 4s (${
                                frameState.framesStack[0]!.speed
                              } seconds). Requests will fail at 5s. This may be normal: first request will take longer in development (as next.js builds), but in production, if there's variance here, requests could fail in production if over 5s`
