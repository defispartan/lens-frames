      ...
      <fieldset className="flex place-items-center flex-col">
        ...
        <div className="my-4 space-y-2">
          {profiles.map((profile, idx) => (
            <label
              key={profile.id}
              className="w-full items-center p-4 rounded-lg cursor-pointer border transition-colors bg-white border-gray-300 hover:border-gray-500 grid grid-cols-[24px_auto]"
            >
              <input
